...
#Get Descriptive Statistics on the desired variables using pastecs
...
female_badeg <- IncomeData$female * IncomeData$ba_degree
options(digits = 2)
options(scipen = 100)
stat.desc(female_badeg)
